  ...
  return (
    ...
    >
      ...
      >
        ...
        <img src="/brand/kindello-mark-clean.png" alt="Kindello" style={{ height: 30, width: "auto", display: "block" }} />
        <span style={{ fontSize: 21, fontWeight: 600, letterSpacing: "-0.02em", color: "var(--color-primary)" }}>
          Kindello
        </span>
      </Link>

      <nav style={{ display: "none", alignItems: "center", gap: 2, marginLeft: 14 }} className="ds-header-nav">
        {NAV.map((n) => {
